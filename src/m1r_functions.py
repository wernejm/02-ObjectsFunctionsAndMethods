...
# I expect the code to print the following:
...
#   Ciao!
#   Bai bai!
# I initially didn't see the ciao/bai bai remarks below the initial "goodbye" print,
# but I was able to properly trace everything.
