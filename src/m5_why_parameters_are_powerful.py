...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50),20,6,'red',10)
    #even_better_draw_circles(rg.Point(-200,0),5,30,'blue',1)
    #even_better_draw_circles(rg.Point(0,0),50,3,'yellow',30)

    even_better_draw_circles(rg.Point(0,0),20,20,'red',10)
    even_better_draw_circles(rg.Point(0,0),30,15,'blue',10)
    even_better_draw_circles(rg.Point(0,0),40,12,'orange',10)
    even_better_draw_circles(rg.Point(0,0),50,10,'green',10)
...
def better_draw_circles(point, increment):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        # Go DOWN *increment* pixels, ending up pointing east again
        turtle.right(90)
        turtle.forward(increment)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(increment * k)
...
def even_better_draw_circles(point, increment, number_of_circles, color, thickness):
