...
def main():
    print(triangle(5,12))
    #turtle_create('red', 15)
    turtle_create('blue', 2)
...
#
# DONE: call that function once, comment it out, then call it again with different values
#
###############################################################################

def turtle_create(color, thickness):
    window = rg.TurtleWindow()
    jimmy = rg.SimpleTurtle()
    jimmy.pen = rg.Pen('green', thickness)
    joey = rg.SimpleTurtle()
    joey.pen = rg.Pen(color, 5)
